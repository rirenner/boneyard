...
epgUbuntu = EPG('Ubuntu', app)
epgFedora = EPG('Fedora', app)
...
epgUbuntu.provide(contract)
epgUbuntu.consume(contract)
epgFedora.consume(contract)
epgFedora.provide(contract)
