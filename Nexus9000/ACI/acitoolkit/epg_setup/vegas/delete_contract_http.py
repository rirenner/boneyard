...
#Remove contract http_contract from Fedora
JsonFedora = {"fvAEPg":{"attributes":{"dn":"uni/tn-Vegas/ap-anpVegas/epg-Fedora","status":"modified"},"children":[{"fvRsCons":{"attributes":{"dn":"uni/tn-Vegas/ap-anpVegas/epg-Fedora/rscons-http_contract","status":"deleted"},"children":[]}}]}}
...
#Remove contract http_contract from Ubuntu 
JsonUbuntu = {"fvAEPg":{"attributes":{"dn":"uni/tn-Vegas/ap-anpVegas/epg-Ubuntu","status":"modified"},"children":[{"fvRsProv":{"attributes":{"dn":"uni/tn-Vegas/ap-anpVegas/epg-Ubuntu/rsprov-http_contract","status":"deleted"},"children":[]}}]}}
...
JsonFilter = {"fvTenant":{"attributes":{"dn":"uni/tn-Vegas","status":"modified"},"children":[{"vzFilter":{"attributes":{"dn":"uni/tn-Vegas/flt-http_contractHTTP","status":"deleted"},"children":[]}}]}}
