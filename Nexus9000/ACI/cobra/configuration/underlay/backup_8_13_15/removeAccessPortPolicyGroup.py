...
class RemoveAccessPortPortPolicyGroup(CreateMo):
    ...
    def __init__(self):
        ...
        self.group = None
        super(RemoveAccessPortPortPolicyGroup, self).__init__()

    def set_cli_mode(self):
        super(RemoveAccessPortPortPolicyGroup, self).set_cli_mode()
    ...
    def delete_mo(self):
        ...
        super(RemoveAccessPortPortPolicyGroup, self).delete_mo()
...
if __name__ == '__main__':
    mo = RemoveAccessPortPortPolicyGroup()
