...
def remove_physical_domain(uni, physical_domain, **args):
    """Remove a Physical domain. Physical domain profile is a policy pertaining to single Physical Management domain that also corresponds to a single policy enforcement domain: representing the physical binding of Tenant/EPGs. """
...
class RemovePhysicalDomain(CreateMo):

    def __init__(self):
        self.description = 'Remove a Physical domain. Physical domain profile is a policy pertaining to single Physical Management domain that also corresponds to a single policy enforcement domain: representing the physical binding of Tenant/EPGs. '
        self.physical_domain = None
        super(RemovePhysicalDomain, self).__init__()

    def set_cli_mode(self):
        super(RemovePhysicalDomain, self).set_cli_mode()
    ...
    def delete_mo(self):
        ...
        super(RemovePhysicalDomain, self).delete_mo()

    def main_function(self):
        # Query a tenant
        self.look_up_mo('uni/', '')
        remove_physical_domain(self.mo, self.physical_domain, optional_args=self.optional_args)

if __name__ == '__main__':
    mo = RemovePhysicalDomain()
