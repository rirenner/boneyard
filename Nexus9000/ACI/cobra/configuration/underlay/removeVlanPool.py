...
class RemoveVlanPool(CreateMo):

    def __init__(self):
        self.description = 'Remove VLAN Pool, the policy definition for ID ranges used for VLAN encapsulation.'
        self.vlan_name = None
        self.vlan_mode = None
        self.range_from = None
        self.range_to = None
        super(RemoveVlanPool, self).__init__()

    def set_cli_mode(self):
        super(RemoveVlanPool, self).set_cli_mode()
    ...
    def delete_mo(self):
        ...
        super(RemoveVlanPool, self).delete_mo()

    def main_function(self):
        self.look_up_mo('uni/infra','')
        remove_vlan_pool(self.mo, self.vlan_name, self.vlan_mode, str(self.range_from), str(self.range_to))
