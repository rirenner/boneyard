...
userJson = {'fvTenant': {'attributes': {'name' : 'RESTTenant'}}}
rsp = sess.post('https://10.15.254.33/api/mo/uni.json', data=json.dumps(userJson, sort_keys=True, indent=4, separators=(',', ':')), verify=False)
